...
export default class FileStorageConcept {
   ...
   * @returns {{file: FileID}} The ID of the newly uploaded file, or an error if a file with the same name already exists.
   */
  async upload(
   ...
   * @returns {{file: FileID}} The ID of the removed file, or an error if the file is not found.
   */
  async remove(
    { name }: { name: string },
  ): Promise<{ file: FileID }> {
   ...
   * @returns {{file: FileID}} The ID of the renamed file, or an error if the original file is not found or the new name already exists.
   */
  async rename(
